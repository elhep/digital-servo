...
#
# Generated by export_simulation on Fri Feb 12 18:24:30 CET 2021
#
################################################################################
...
'-reset_run' switch to the './dds_PG_pw24.sh' script.

./dds_PG_pw24.sh -reset_run
...
./dds_PG_pw24.sh -noclean_files

For more information on the script, please type './dds_PG_pw24.sh -help'.
