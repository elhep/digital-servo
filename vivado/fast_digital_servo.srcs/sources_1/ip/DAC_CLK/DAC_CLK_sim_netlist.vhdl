...
--               /home/jmatyas/dev/fast-digital-servo/vivado/fast_digital_servo.srcs/sources_1/ip/DAC_CLK/DAC_CLK_sim_netlist.vhdl
-- Design      : DAC_CLK
...
entity DAC_CLK_DAC_CLK_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of DAC_CLK_DAC_CLK_clk_wiz : entity is "DAC_CLK_clk_wiz";
end DAC_CLK_DAC_CLK_clk_wiz;

architecture STRUCTURE of DAC_CLK_DAC_CLK_clk_wiz is
  signal clk_in1_DAC_CLK : STD_LOGIC;
  signal clk_out1_DAC_CLK : STD_LOGIC;
  signal clkfbout_DAC_CLK : STD_LOGIC;
  signal clkfbout_buf_DAC_CLK : STD_LOGIC;
...
begin
inst: entity work.DAC_CLK_DAC_CLK_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,
