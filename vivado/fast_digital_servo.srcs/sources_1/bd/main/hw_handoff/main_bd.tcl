...
proc create_root_design { parentCell } {
  ...
  set AD9117_RESET_0 [ create_bd_port -dir O -type rst AD9117_RESET_0 ]
  set AT_EVENT_0 [ create_bd_port -dir I AT_EVENT_0 ]
  set CLK_100_0 [ create_bd_port -dir I CLK_100_0 ]
  set DIO_0 [ create_bd_port -dir O -from 1 -to 0 DIO_0 ]
  set ETH_LEDS_0 [ create_bd_port -dir O -from 1 -to 0 ETH_LEDS_0 ]
  set FPGA_CLK1_N_0 [ create_bd_port -dir I FPGA_CLK1_N_0 ]
  set FPGA_CLK1_P_0 [ create_bd_port -dir I FPGA_CLK1_P_0 ]
  set FPGA_CLK2_N_0 [ create_bd_port -dir I FPGA_CLK2_N_0 ]
  set FPGA_CLK2_P_0 [ create_bd_port -dir I FPGA_CLK2_P_0 ]
  set FP_LEDS_0 [ create_bd_port -dir O -from 3 -to 0 FP_LEDS_0 ]
  set LEDS_0 [ create_bd_port -dir O -from 2 -to 0 LEDS_0 ]
  ...
  set adc_ss [ create_bd_port -dir O adc_ss ]
  set dac_sclk [ create_bd_port -dir O dac_sclk ]
  set dac_sdio [ create_bd_port -dir IO dac_sdio ]
  set dac_ss [ create_bd_port -dir O dac_ss ]
  ...
  # Create instance: adc_spi_ss, and set properties
  set adc_spi_ss [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 adc_spi_ss ]
  set_property -dict [ list \
   CONFIG.NUM_PORTS {3} \
 ] $adc_spi_ss

  # Create instance: dac_spi_ss, and set properties
  set dac_spi_ss [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 dac_spi_ss ]
  set_property -dict [ list \
   CONFIG.NUM_PORTS {3} \
 ] $dac_spi_ss
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_PCAP_PERIPHERAL_FREQMHZ {194} \
   CONFIG.PCW_ACT_QSPI_PERIPHERAL_FREQMHZ {194} \
   CONFIG.PCW_ACT_SDIO_PERIPHERAL_FREQMHZ {97} \
   CONFIG.PCW_ACT_SMC_PERIPHERAL_FREQMHZ {10} \
   CONFIG.PCW_ACT_SPI_PERIPHERAL_FREQMHZ {159} \
   ...
   CONFIG.PCW_ACT_UART_PERIPHERAL_FREQMHZ {97} \
   ...
   CONFIG.PCW_IOPLL_CTRL_FBDIV {53} \
   CONFIG.PCW_IO_IO_PLL_FREQMHZ {1749} \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {unassigned#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#unassigned#unassigned#unassigned#UART 0#UART 0#unassigned#unassigned#unassigned#unassigned#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#Enet 0#Enet 0} \
  ...
  connect_bd_net -net AT_EVENT_0_1 [get_bd_ports AT_EVENT_0] [get_bd_pins FastServoTop_0/AT_EVENT]
  ...
  connect_bd_net -net FPGA_CLK2_N_0_1 [get_bd_ports FPGA_CLK2_N_0] [get_bd_pins FastServoTop_0/FPGA_CLK2_N]
  connect_bd_net -net FPGA_CLK2_P_0_1 [get_bd_ports FPGA_CLK2_P_0] [get_bd_pins FastServoTop_0/FPGA_CLK2_P]
  ...
  connect_bd_net -net FastServoTop_0_AD9117_RESET [get_bd_ports AD9117_RESET_0] [get_bd_pins FastServoTop_0/AD9117_RESET]
  connect_bd_net -net FastServoTop_0_DIO [get_bd_ports DIO_0] [get_bd_pins FastServoTop_0/DIO]
  connect_bd_net -net FastServoTop_0_ETH_LEDS [get_bd_ports ETH_LEDS_0] [get_bd_pins FastServoTop_0/ETH_LEDS]
  connect_bd_net -net FastServoTop_0_FP_LEDS [get_bd_ports FP_LEDS_0] [get_bd_pins FastServoTop_0/FP_LEDS]
  connect_bd_net -net FastServoTop_0_LEDS [get_bd_ports LEDS_0] [get_bd_pins FastServoTop_0/LEDS]
  ...
  connect_bd_net -net Net [get_bd_ports dac_sdio] [get_bd_pins spi_buff_wrapper_0/sdio]
  connect_bd_net -net adc_spi_buff_wrapper_0_o_mosi [get_bd_ports adc_mosi] [get_bd_pins adc_spi_buff_wrapper_0/o_mosi]
  connect_bd_net -net adc_spi_buff_wrapper_0_o_sclk [get_bd_ports adc_sclk] [get_bd_pins adc_spi_buff_wrapper_0/o_sclk]
  connect_bd_net -net adc_spi_buff_wrapper_0_o_ss [get_bd_ports adc_ss] [get_bd_pins adc_spi_buff_wrapper_0/o_ss]
  ...
  connect_bd_net -net adc_spi_ss_dout [get_bd_pins adc_spi_buff_wrapper_0/ps_ss] [get_bd_pins adc_spi_ss/dout]
  connect_bd_net -net i_miso_0_1 [get_bd_ports adc_miso] [get_bd_pins adc_spi_buff_wrapper_0/i_miso]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins FastServoTop_0/rst_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  ...
  connect_bd_net -net processing_system7_0_SPI0_SS1_O [get_bd_pins adc_spi_ss/In1] [get_bd_pins processing_system7_0/SPI0_SS1_O]
  connect_bd_net -net processing_system7_0_SPI0_SS2_O [get_bd_pins adc_spi_ss/In2] [get_bd_pins processing_system7_0/SPI0_SS2_O]
  connect_bd_net -net processing_system7_0_SPI0_SS_O [get_bd_pins adc_spi_ss/In0] [get_bd_pins processing_system7_0/SPI0_SS_O]
  ...
  connect_bd_net -net processing_system7_0_SPI1_SS1_O [get_bd_pins dac_spi_ss/In1] [get_bd_pins processing_system7_0/SPI1_SS1_O]
  connect_bd_net -net processing_system7_0_SPI1_SS2_O [get_bd_pins dac_spi_ss/In2] [get_bd_pins processing_system7_0/SPI1_SS2_O]
  connect_bd_net -net processing_system7_0_SPI1_SS_O [get_bd_pins dac_spi_ss/In0] [get_bd_pins processing_system7_0/SPI1_SS_O]
  ...
  connect_bd_net -net spi_buff_wrapper_0_o_sclk [get_bd_ports dac_sclk] [get_bd_pins spi_buff_wrapper_0/o_sclk]
  connect_bd_net -net spi_buff_wrapper_0_o_ss [get_bd_ports dac_ss] [get_bd_pins spi_buff_wrapper_0/o_ss]
  ...
  connect_bd_net -net xlconcat_0_dout [get_bd_pins dac_spi_ss/dout] [get_bd_pins spi_buff_wrapper_0/ps_ss]
